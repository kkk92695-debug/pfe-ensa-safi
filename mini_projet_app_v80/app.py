...
if dark:
    ...
    [data-testid="stExpander"] details summary { background: #ffffff !important; color: #0f172a !important; }
    [data-testid="stExpander"] details > div { background: #ffffff !important; }
    [data-testid="stExpander"] * { color: #0f172a !important; -webkit-text-fill-color: #0f172a !important; background-color: transparent; }
    [data-testid="stExpander"] details summary * { background: #ffffff !important; }
    [data-testid="stExpander"] input, [data-testid="stExpander"] textarea { background: #f8fafc !important; color: #0f172a !important; border: 1px solid #cbd5e1 !important; }
